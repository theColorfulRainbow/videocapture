...
VIDEO_DIRECTORY = os.path.join(os.getcwd(), "Videos/segmented_videos")
...
def main():
    ...
    videos = [Video("SCEE08007","2019-2020","2020-01-17T12:00Z","secondary.mp4","/afs/inf.ed.ac.uk/user/s16/s1645821/lecture_recording/TestingEnvironment/segment/Videos/test_videos/James_Hopgood_Lecture_Trim.mp4")]
